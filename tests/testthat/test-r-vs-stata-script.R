...
"
  ...
  expect_equivalent(boot_lm1$p_val, stata_p_val, tolerance = tol)
...
"
  ...
  stata_p_val <- unique(res$p_val)
  expect_equivalent(boot_lm2$p_val,  stata_p_val, tolerance = tol)
...
"
  ...
  stata_p_val <- unique(res$p_val)
  expect_equivalent(boot_lm3$p_val,  stata_p_val, tolerance = tol)
...
"
  ...
  stata_p_val <- unique(res$p_val)
  expect_equivalent(boot_lm4$p_val,  stata_p_val, tolerance = tol)
...
"
  ...
  stata_p_val <- unique(res$p_val)
  expect_equivalent(boot_lm5$p_val,  stata_p_val, tolerance = tol)
...
"
  ...
  stata_p_val <- unique(res$p_val)
  expect_equivalent(boot_lm6$p_val,  stata_p_val, tolerance = tol)
...
"
  ...
  stata_p_val <- unique(res$p_val)
  expect_equivalent(boot_lm7$p_val,  stata_p_val, tolerance = tol)
...
"
  ...
  res <- RStata::stata(test_3, data.out = TRUE)
  stata_p_val <- unique(res$p_val)
  expect_equivalent(boot_lm3$p_val,  stata_p_val, tol = 5 * tolerance = tol) # note: this test fails at tol = 0.01
...
"
  ...
  expect_equivalent(boot_lm1$conf_int[1], stata_conf_int_l, tolerance = tol)
  expect_equivalent(boot_lm1$conf_int[2], stata_conf_int_u, tolerance = tol)
...
"
  ...
  expect_equivalent(boot_lm2$conf_int[1], stata_conf_int_l, tolerance = tol)
  expect_equivalent(boot_lm2$conf_int[2], stata_conf_int_u, tolerance = tol)
...
"
  ...
  expect_equivalent(boot_lm3$conf_int[1], stata_conf_int_l, tolerance = tol)
  expect_equivalent(boot_lm3$conf_int[2], stata_conf_int_u, tolerance = tol)
...
"
  ...
  expect_equivalent(boot_lm4$conf_int[1], stata_conf_int_l, tolerance = tol)
  expect_equivalent(boot_lm4$conf_int[2], stata_conf_int_u, tolerance = tol)
...
"
  ...
  expect_equivalent(boot_lm5$conf_int[1], stata_conf_int_l, tolerance = tol) # fails at tol = 0.01
  expect_equivalent(boot_lm5$conf_int[2], stata_conf_int_u, tolerance = tol)
...
"
  ...
  expect_equivalent(boot_lm6$conf_int[1], stata_conf_int_l, tolerance = tol)
  expect_equivalent(boot_lm6$conf_int[2], stata_conf_int_u, tolerance = tol)
...
"
  ...
  expect_equivalent(boot_lm7$conf_int[1], stata_conf_int_l, tolerance = tol)
  expect_equivalent(boot_lm7$conf_int[2], stata_conf_int_u, tolerance = tol)
...
"
  ...
  expect_equivalent(boot_lm5$conf_int[1], stata_conf_int_l, tolerance = tol)
  expect_equivalent(boot_lm5$conf_int[2], stata_conf_int_u, tolerance = tol)
...
"
  res <- RStata::stata(test_1, data.out = TRUE)
  stata_p_val <- unique(res$p_val)
  expect_equivalent(boot_lm1$p_val, stata_p_val)
...
"
  ...
  res <- RStata::stata(test_3, data.out = TRUE)
  stata_p_val <- unique(res$p_val)
  expect_equivalent(boot_lm3$p_val,  stata_p_val)
...
"
  res <- RStata::stata(test_5, data.out = TRUE)
  stata_p_val <- unique(res$p_val)
  expect_equivalent(boot_lm5$p_val,  stata_p_val)
...
"
  ...
  res <- RStata::stata(test_7, data.out = TRUE)
  stata_p_val <- unique(res$p_val)
  expect_equivalent(boot_lm7$p_val,  stata_p_val)
...
"
  res <- RStata::stata(test_2, data.out = TRUE)
  stata_p_val <- unique(res$p_val)
  expect_equivalent(boot_lm2$p_val,  stata_p_val)
